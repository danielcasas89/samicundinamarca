...
var DbOffline = {
    ...
    init: function(callback, callbackError){
        ...
        DbOffline.indexedDB = window.indexedDB || window.mozIndexedDB || window.webkitIndexedDB || window.msIndexedDB;
        //VARIABLE DE LA DB
        ...
        DbOffline.dataBase.onupgradeneeded = function (e) {
            ...
            var object = active.createObjectStore(
                "encuestas", 
                {
                    keyPath:"id",
                    autoIncrement: false
            ...
            //CREAMOS UNA COLECCION (TABLAS) LLAMADA encuesta CUYA LLAVE ES id Y ES AUTOINCREMENTABLE
            var object2 = active.createObjectStore(
                "configuracion", 
                {
                    keyPath:"id",
                    autoIncrement: true
